...
import type { Post, PublishStatus, PlatformStatus } from '@/types';
...
interface StorageInterface {
  ...
  updatePost(id: string, updateData: Partial<Omit<Post, 'id' | 'created_at'>>): Promise<Post | null>;
...
function migratePost(post: Post & Partial<{ publishStatus: PublishStatus; channelConfig: unknown }>): Post {
  return {
    ...post,
...
class MemoryStorage implements StorageInterface {
  ...
  async initialize(): Promise<void> {
    ...
    this.posts = initialPosts.map((post, index) => ({
      ...post,
