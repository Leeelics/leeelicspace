    ...
    <div className="min-h-screen bg-gray-50 dark:bg-catppuccin-base">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between h-16">
            <div className="flex items-center">
              <h1 className="text-xl font-bold text-gray-900 dark:text-catppuccin-text">
                管理后台
              </h1>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-lg shadow p-6 dark:bg-catppuccin-surface0 dark:border dark:border-catppuccin-surface1">
          <h2 className="text-xl font-bold mb-6 text-gray-900 dark:text-catppuccin-text">
            网站设置
          </h2>
          ...
          {/* 主题设置 */}
          <div className="mb-8">
            <h3 className="text-lg font-semibold mb-4 text-gray-900 dark:text-catppuccin-text">
              主题设置
            </h3>
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between p-4 border border-gray-200 rounded-lg dark:border-catppuccin-surface1">
                <div>
                  <h4 className="font-medium text-gray-900 dark:text-catppuccin-text">
                    浅色主题
                  </h4>
                  <p className="text-sm text-gray-600 dark:text-catppuccin-subtext0">
                    经典的浅色外观
                  </p>
                </div>
                <input
