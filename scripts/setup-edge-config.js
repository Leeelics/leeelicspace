...
if (edgeConfigMatch) {
  ...
  console.log(
    "Current value:",
    envContent.match(/^EDGE_CONFIG=(.+)$/m)?.[1] || "empty",
  );
} else {
  ...
  console.log(
    "Please update it with your actual connection string from Vercel dashboard",
  );
}
...
console.log(
  "   - Middleware: http://localhost:3000/welcome (should return JSON)",
);
