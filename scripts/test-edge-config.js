...
async function testEdgeConfig() {
  ...
  try {
    ...
    if (greeting) {
      ...
      console.log('💡 Make sure you have a "greeting" key set in your Edge Config store');
    }
    
    console.log('\n🎯 Test Results:');
    console.log('- Connection: ✅ Working');
    console.log('- Data retrieval:', greeting ? '✅ Success' : '⚠️  No data found');
    console.log('- Integration:', greeting ? '✅ Ready' : '⚠️  Needs configuration');
    ...
    if (error.message.includes('EDGE_CONFIG')) {
      ...
      console.log('3. Check that your Edge Config store exists in Vercel dashboard');
    }
  ...
  console.log('\n📚 Next Steps:');
  console.log('1. If connection failed, check your EDGE_CONFIG environment variable');
  console.log('2. Visit your Vercel dashboard to get the correct connection string');
